...
function StarLayer({
  ...
  return (
    <motion.div
      ...
      className={cn("absolute top-0 left-0 w-full h-[4000px]", className)}
      {...props}
    >
      <div
      ...
      />
      <div
        className="absolute bg-transparent rounded-full top-[4000px]"
        style={{
          width: `${size}px`,
          height: `${size}px`,
          boxShadow: boxShadow,
...
export function StarsBackground({
  ...
  return (
    <div
      ...
      style={{
         background: 'radial-gradient(ellipse at bottom, var(--bg) 0%, #000 100%)'
      }}
